      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-md-12">
            ...
            <div className="">
              <h5 className="lead">
              <p> Now you can login using your (any) Google account.</p></h5>
            </div>
            <hr />
            <p>
            ...
            <h5>
               EMS is a full stack web app build using the MERN stack
            ...
            <div className="highlightedProject">
              ...
              <div className="description">
                <p>
                  ...
                  , Attendence and a lot of other things regarding the
